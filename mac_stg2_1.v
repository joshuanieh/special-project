...
module mac_stg2_1(input           i_clk,
                ...
                output [14-1:0] shifted_unsign_pp3,
                output [14-1:0] shifted_unsign_pp4,
                output [14-1:0] shifted_unsign_pp5,
                output [14-1:0] shifted_unsign_pp6,
                output [14-1:0] shifted_unsign_pp7,
                output [14-1:0] shifted_unsign_pp8,
                output [14-1:0] shifted_unsign_pp9,
                output          pp_sign1,
                output          pp_sign2,
                output          pp_sign3,
                output          pp_sign4,
